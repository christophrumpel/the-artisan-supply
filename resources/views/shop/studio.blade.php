<x-shop-layout title="Studio | The Artisan Supply">
    <section class="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-20">
        <div class="max-w-3xl">
            ...
            <h1 class="mt-5 text-5xl font-black tracking-tight text-white">Tiny workflows before AI helps.</h1>
        ...
        <div class="mt-12 grid gap-6 lg:grid-cols-2">
            <article class="rounded-[2rem] border border-white/10 bg-white/[0.05] p-6 backdrop-blur">
                <p class="text-sm font-bold uppercase tracking-widest text-red-100">1. Assets Manager</p>
                <h2 class="mt-3 text-2xl font-black text-white">Uploaded assets</h2>
                <p class="mt-3 text-sm leading-6 text-stone-400">Today, shopkeepers upload files and edit metadata manually. Later, AI can inspect the upload and fill these fields automatically.</p>
                <div class="mt-6 space-y-3">
                    @foreach ($assets as $asset)
                        <div class="rounded-2xl bg-black/20 p-4">
                            ...
                            <p class="text-sm text-red-100">Alt text: {{ $asset->alt_text ?? 'Not written yet' }}</p>
                        </div>
                    @endforeach
                </div>
            </article>
            ...
            <article class="rounded-[2rem] border border-white/10 bg-white/[0.05] p-6 backdrop-blur">
                <p class="text-sm font-bold uppercase tracking-widest text-red-100">2. Support reply</p>
